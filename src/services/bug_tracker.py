...
from repositories.subproject_repository import (subproject_repository as
                                                default_subproject_repository)
...
class BugTrackerService:
    ...
    def get_id(self, project_name, subproject_name=None, bug_name=None):
        ...
        if subproject_name:
            subproject_id = self._subproject_repository.get_subproject_id(project_id,
            subproject_name)
            if bug_name:
