...
class ProjectView:
    ...
    def _initialize(self):
        ...
        title_app = ttk.Label(master=self._frame,
        text="Bugiseurantasovellus",
        font='Arial 20 bold')

        desc_app_1 = ttk.Label(master=self._frame,
        text="Sovellukseen voi raportoida eri projekteista löytyneitä virheitä tai puutteita.")

        desc_app_2 = ttk.Label(master=self._frame,
        text="Sovelluksen tarkoituksena on toimia apuna virheiden tilan seurannassa.")

        desc_app_3 = ttk.Label(master=self._frame,
        text="Voit tarkastella olemassa olevia projekteja tai luoda uuden projektin.")
        ...
        title_open_project = ttk.Label(master=self._frame,
        text="Avaa projekti",
        font='Arial 20 bold')

        desc_open_project = ttk.Label(master=self._frame,
        text="Valitse alta projekti, jota haluat tarkastella.",
        font='Arial 14')
        ...
        if not project_options:
            label_no_projects = ttk.Label(master=self._frame,
            text="Huom! Tässä sovelluksessa ei ole vielä projekteja")
        ...
        title_new_project = ttk.Label(master=self._frame,
        text="Luo uusi projekti",
        font='Arial 20 bold')

        desc_new_project_1 = ttk.Label(master=self._frame,
        text="Voit luoda uuden projektin kirjoittamalla sille nimen.",
        font='Arial 14')

        desc_new_project_2 = ttk.Label(master=self._frame,
        text="Nimi ei voi olla sama kuin jollain toisella projektilla.",
        font='Arial 14')

        self._entry_project = ttk.Entry(master=self._frame)
        button_new_project = ttk.Button(master=self._frame,
        text="Luo",
